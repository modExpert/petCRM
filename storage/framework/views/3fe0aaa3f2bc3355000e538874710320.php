            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="<?php echo e(route('projects.store')); ?>" method="POST">
                        ...
                        <a href="<?php echo e(route('projects.index')); ?>" class="btn btn-secondary">Отмена</a>
                    </form>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/alex/example-app/resources/views/projects/create.blade.php ENDPATH**/ ?>